...
export default function InviteCard({ visible, username, energyScore, avatarColors, avatarUrl, userId, onClose }: Props) {
  ...
  const downloadCard = () => {
    ...
    const c = avatarColors ?? ['#FFB347', '#FF7E5F', '#70A1FF'];
    ...
    codeGrad.addColorStop(0, '#FFB347');
    codeGrad.addColorStop(1, '#FFCC33');
...
const styles = StyleSheet.create({
  ...
  sheet: {
    backgroundColor: '#0A0F1E', borderTopLeftRadius: 28, borderTopRightRadius: 28,
  ...
  codeText: { color: '#0A0F1E', fontSize: 18, fontWeight: '700', letterSpacing: 4 },
  ...
  actionBtnPrimaryText: { color: '#0A0F1E', fontSize: 14, fontWeight: '600' },
